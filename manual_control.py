...
context= zmq.Context()
socket_telemetry = context.socket(zmq.PUB)
socket_telemetry.bind("tcp://*:7979")
...
class World(object):
    ...
    def restart(self):
        ...
        cam_index1 = self.camera_manager1.index if self.camera_manager1 is not None else 0
        cam_pos_index1 = self.camera_manager1.transform_index if self.camera_manager1 is not None else 0
        ...
        self.camera_manager1 = CameraManager(self.player, self.hud, self._gamma)
    ...
    def destroy_sensors(self):
        ...
        self.camera_manager1.sensor.destroy()
        self.camera_manager1.sensor = None
        self.camera_manager1.index = None
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if self._is_quit_shortcut(event.key):
                    ...
                    world.camera_manager1.toggle_camera()
                    ...
                    world.camera_manager1.next_sensor()
                elif event.key == K_n:
                    world.camera_manager.next_sensor()
                    world.camera_manager1.next_sensor()
                    ...
                    world.camera_manager1.set_sensor(event.key - 1 - K_0 + index_ctrl)
                elif event.key == K_r and not (pygame.key.get_mods() & KMOD_CTRL):
                    world.camera_manager.toggle_recording()
                    world.camera_manager1.toggle_recording() 
...
class IMUSensor(object):
    ...
    # @staticmethod
    # def MOOG_INFO(x, y):
    #     print("x: " + str(round(x, 4)) + ", Y: " + str(round(y, 4)))
    #     return
    ...
    def _IMU_callback(weak_self, sensor_data):
        ...
        # print('Linear Acceleratioin XYZ:\n', [self.accelerometer[0], self.accelerometer[1], self.accelerometer[2]])
        # print('Angular Acceleration Roll_Pitch_Yaw:\n', [self.gyroscope[0], self.gyroscope[1], self.gyroscope[2]])
        
        try:
            socket_telemetry.send("%d %d %d %d %d %d" % (self.accelerometer[0], self.accelerometer[1], self.accelerometer[2], self.gyroscope[0], self.gyroscope[1], self.gyroscope[2]))
            print('Angular Acceleration Roll_Pitch_Yaw:\n', [self.gyroscope[0], self.gyroscope[1], self.gyroscope[2]])
            # time.sleep(0.001)
        except:
            print('TCP Exception...')
